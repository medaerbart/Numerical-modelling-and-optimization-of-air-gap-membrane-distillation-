...
% All formulas from Hitsov et al.
% Best intill now.
% File for calibration
%%% Hot and cold channel parameters
sp_fil_t = 1.005/1000;               % Spacer filament thickness [m]
sp_ang = 60;                         % Spacer angle
sp_fil_l = 4.17/1000;                % Spacer filament length [m]
tchan = 2.01/1000;                   % Thickness of the channel
sp_por = 1-(pi*sp_fil_t^2/(2*sp_fil_l*tchan*sin(sp_ang/180*pi))); % Spacer porosity

%%% Module parameters
%Lmd = 1.5;                           % Lenght of module             [m]
Wmd = 0.4;                            % Width of module              [m] 
dz = Lmd/N;                           % Discretization length            
Am = dz*Wmd;%;                        % Membrane area of each cell on one side
%Nchan = 6;                           % Number of envelopes in the module [-]

%%% Membrane parameters
k_mem_mat = 0.35;                    % conductivity membrane material
por_mem = 0.84;                      % Porosity membrane
t_mem = 92e-6;                       % Thickness of the membrane
r_mem = 1.6e-7;                      % Membrane pore radius [m]
tor_mem = (2-por_mem)^2/por_mem;     % Membrane turtuosity
%%% Air gap parameters
t_airgap = 0.4/1000;                % Thickness of airgap [m]
sa_fil_t = 0.405/1000;               % Spacer filament thickness [m]
sa_ang = 90;                         % Spacer angle
sa_fil_l = 3.33/1000;                % Spacer filament length [m]
k_sp = 0.195;                        % conductivity spacer material [W/mK]
sa_por = 1-(pi*sa_fil_t^2/(2*sa_fil_l*t_airgap*sin(sa_ang/180*pi))); % Spacer porosity
t_cond = 143.5/10^6;                 % Condensate layer [m]

%%% Condensor parameters
hc = 8900;                           % Heat transfer of condensor [W/m^2K]

%%% Physical properties
R = 8.3144598;                       % Universal gasconstant
M = 0.018015281;                     % Moleculair wheight of water [kg/mol]
MNaCl = 0.05844;                     % Moleculair wheight of NaCl [kg/mol]
kb = 1.38064852e-23;                 % Boltzmann constant
de = 2.64e-10;                       % collision diameter of water vapour
